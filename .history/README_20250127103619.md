...
The liver_ndp_tree_building submodule is used to run-dimensional dirichlet process (NDP) to cluster mutations based on VAFs, and, subsequently, generate phylogenetic trees based on the pigeonhole principle.
