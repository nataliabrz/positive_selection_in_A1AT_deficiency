...
selcvHH <- read.table("outputs/dnds/HH_dndsout_selcv.tsv",sep="\t",header=T)
selcvA1AD <- read.table("outputs/dnds/A1AD_dndsout_selcv.tsv",sep="\t",header=T)

outpath <- "outputs/figures/"
```
...
ggsave("outputs/figures/Fig1c_dnds_pManhattan.pdf", plot = combined_plot, width = 12, height = 3.6)
```
