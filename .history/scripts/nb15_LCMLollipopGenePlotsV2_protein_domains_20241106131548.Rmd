...
annotmuts <- read.table(paste0(dndsPath,"dndsout_annotmuts.tsv"), sep="\t", header=T)
sel_cv <- read.table(paste0(dndsPath,"sel_cv.tsv"), sep="\t", header=T)
...
qval = round(sel_cv[sel_cv$gene == goi[g],"qglobal_cv"],digits=2)
