...
# rmarkdown::render('reports/A1AD_HH_dnds_manhattan_plot_Fig_1c.Rmd', output_file = 'A1AD_HH_dnds_manhattan_plot_Fig_1c', output_dir = 'reports/')
...
```{r plot_result_haemochromatosis}
...
```{r pManhattan, fig.width = 12, fig.height = 3.6}
pManhattanA1AD + pManhattanHH + plot_annotation(tag_levels = "a")


combined_plot <- pManhattanA1AD + pManhattanHH + plot_annotation(tag_levels = 'a')
# ggsave("outputs/pManhattanA1AD_PDv38is_wgs.pdf", plot = pManhattanA1AD, width = 6, height = 3.6)
# ggsave("outputs/pManhattanHH_PDv38is_wgs.pdf", plot = pManhattanHH, width = 6, height = 3.6)
ggsave("outputs/pManhattan_side_by_side_PDv38is_wgs.pdf", plot = combined_plot, width = 12, height = 3.6)
```
