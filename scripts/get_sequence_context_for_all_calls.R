...
exome_calls <- fread("/lustre/scratch126/casm/team154pc/nb15/a1ad_paper/data/calls/exome_calls.csv", sep = ",") %>%
  mutate(
...
write.table(out.table, file = "/lustre/scratch126/casm/team154pc/nb15/a1ad_paper/data/calls/all_calls_mut_context_GRCh38.txt", quote = F, row.names = F, sep = "\t")
