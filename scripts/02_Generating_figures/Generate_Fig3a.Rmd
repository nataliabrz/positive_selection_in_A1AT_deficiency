...
# save the SERPINA1 mutations for easy access when needed
if ( goi[g] == "SERPINA1") {
write.table(gene,"outputs/dnds/",cohort,"_",goi[g],"_annotmuts.tsv",sep="\t",col.names=T,row.names=F,quote=F)
}
